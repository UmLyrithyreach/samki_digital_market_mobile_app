...
class _BecomeSellerScreenState extends State<BecomeSellerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const SamkiAppBar(title: 'Become a Seller', showBack: true,),
            ...
            ? Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    style: TextStyle(color: SamkiTheme.secondary, height: 1.5),
                  ),
                ],
              )
            : Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  ...[
                    ('Verified seller badge', 'Build customer trust instantly'),
                    (
                      'Reach & exposure',
                    ...
                    ('Local delivery', 'We handle logistics across Cambodia'),
                  ]
                      .map((b) => Padding(
